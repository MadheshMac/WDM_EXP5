...
![Screenshot 2025-04-21 142700](https://github.com/user-attachments/assets/6420e193-1183-4341-8c65-5ae4b0d4072c)


### Result:
The program performs the indexing, prints the document-term matrix, shows all terms, and then outputs the results of the Boolean query for `"python and information"`, which is document 1.
